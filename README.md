...
- **河南专技公需课刷课**（新）：河南省专业技术人员继续教育（jxjyedu.org.cn 及南阳理工/河南大学/郑大等 13 个子站自动跳转主站）课程自动学习——识别未完成课程、章节并发上报进度、悬浮控制台 + 实时日志、学完自动弹完成引导
...
│   ├── adapters/         #   平台适配器（含河南专技刷课驱动）
│   └── sample-bank.json  #   示例题库
├── test/                 # 14 个 jsdom 测试套件（npm test 全量跑）
